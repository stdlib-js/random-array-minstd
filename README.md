...
```javascript
import minstd from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-minstd@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/random-array-minstd/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/random-array-minstd/actions/workflows/test.yml?query=branch:v0.1.0
